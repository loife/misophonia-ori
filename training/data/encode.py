...
class ManyHotEncoder:
    ...
    def __init__(
            self, labels, audio_len=10, frame_hop=160, net_pooling=4, sr=16000
    ):
        ...
        n_frames = self.audio_len * self.sr
    ...
    def _frame_to_time(self, frame):
        frame = frame * self.net_pooling / (self.sr / self.frame_hop)
